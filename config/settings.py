...
SECRET_KEY = 'django-insecure-rf7w1=14_xc6uq*9qrp*!j-t8%%b+uf=))x1scurs&frq9)b5x'
...
AUTH_USER_MODEL = 'accounts.User' # Change the builtin user model to accounts
...
TEMPLATES = [
    {
        ...
        'DIRS': [str(BASE_DIR.joinpath('templates'))], # added by Hikmatullah
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
